...
def main():
	...
	# Save models
	salary_path = ROOT_DIR / "salary_regressor.pkl"
	fake_path = ROOT_DIR / "fake_classifier.pkl"
	joblib.dump(salary_model, salary_path)
	joblib.dump(fake_model, fake_path)
	print(f"Saved models: {salary_path.name}, {fake_path.name}")
